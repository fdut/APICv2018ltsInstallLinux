...
DMPIMGTARGETNAME=`apicup version --images | grep monitor | awk '{ print $2 }' | awk -F"/" '{ print $2 }' `
IDGIMGTARGETNAME=`apicup version --images  | grep datapower-api-gateway | awk '{ print $2 }' | awk -F"/" '{ print $2 }'`
