...
initk8s:
	...
	#sudo chown $LOGNAME:$LOGNAME -R $HOME/.kube/
...
master : checkprereq installk8s installHelm getk8sstatus
...
# to install docker & kube whitout init
node : checkprereq installk8s 
